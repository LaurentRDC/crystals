...
:mod:`crystals` is intended to be general enough to be useable with x-ray, 
...
This way, the details of the scattering experiments are not important to :mod:`crystals`.

General purpose direct indexing with DirAx
------------------------------------------

The first and simplest indexing routine, :func:`index_dirax`, is based on the DirAx algorithm presented in:
